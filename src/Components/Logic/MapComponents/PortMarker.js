...
class PortMarker extends Component {
  ...
  render() {
    ...
    return (
      <div key={ship.imo}>
        <Button style={{maxWidth: '22px', maxHeight: '22px', minWidth: '22px', minHeight: '22px', marginLeft:'-11px', marginTop:'-10px'}} variant="fab" onClick={this.handleToggle} mini color="primary">
